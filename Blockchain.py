...
def new_transaction():
    ...
    payload ="------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"from\"\r\n\r\nMaccabi Games <postmaster@mail.maccabigamesjcc.me>\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"to\"\r\n\r\nEyal <eyalabadi98@hotmail.com>\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"subject\"\r\n\r\nNew Transaction - Verify when received\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"text\"\r\n\r\nYou have been enitiated by a transaction. Please use this one time code to verify once you have received the correct goods and have checked them. Code: " + randomVal + "\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW--"
    headers = {
